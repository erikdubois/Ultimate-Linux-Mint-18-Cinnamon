...
# other interesting software I used to figure it all out is
# sublime-text - script on this github
# brackets - script on this github
# catfish - just do sudo apt install catfish
